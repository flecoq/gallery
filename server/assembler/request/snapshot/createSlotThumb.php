...
$cmd = '"C:/Program Files/ImageMagick-7.0.10-Q16-HDRI/magick.exe" -size 500x500 xc:rgba(255,255,255,0.5) ( '.$source.' -crop 500x500+515+185 ) -composite '.$dest.'\\'.$data->filename.'.png';
exec($cmd);
